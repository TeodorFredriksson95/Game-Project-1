...
public class Weapon : MonoBehaviour
{
	...
	public void Equip(WeaponData data)
	{
		...
		switch (equippedWeapon)
		{
			case Weapons.Dagger:
				...
				animator.runtimeAnimatorController = daggerAnimatorController;
                break;
			...
			case Weapons.Staff:
                ...
                animator = GetComponentInChildren<Animator>();
                animator.runtimeAnimatorController = staffAnimatorController;
                break;
	...
	public void RangedAttack()
	{
		...
		attackTime = weaponData.AttackCooldown * CDR;
	}

	public GameObject StaffTip => staffTip;
	public float AttackCooldown { get; set; }
	public float CDR { get; set; } = 1f;
