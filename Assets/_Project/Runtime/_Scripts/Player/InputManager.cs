...
public class InputManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        inputMode = PlayerPrefs.GetInt("OneHandedSetting", 0) == 1 ? InputMode.OneHanded : InputMode.Standard;
        if(inputMode == InputMode.OneHanded)
        {
            GetComponent<PlayerInput>().SwitchCurrentActionMap("OneHanded");
        }
    }
