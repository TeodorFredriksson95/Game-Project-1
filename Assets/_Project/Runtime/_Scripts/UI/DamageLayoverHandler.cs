...
public class DamageLayoverHandler : MonoBehaviour // Mostly vibecoded by vibeGPT - UwU
{
    ...
    [Range(0f, 1f)]
    [SerializeField] private float maxAlphaAtZeroHP = 0.31f;
    [Range(1f, 20f)]
    ...
    private void OnEnable()
    {
        ...
        PlayerHealth.OnPlayerDied += ResetDamageLayoverChange;
    }
    ...
    private void ResetDamageLayoverChange()
    {
